...
This command generate the smart contract binary **NotarizedDocument.bin** and the interface **NotarizedDocument.abi** for the smart contract **NotarizedDocument.sol**
